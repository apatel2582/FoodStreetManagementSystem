...
namespace FoodStreetManagementSystem.ViewModels
{
    public class MenuManagementViewModel : ObservableObject, IMenuManagementViewModel
    {
        ...
        private bool _isAddingUser = false;
        ...
        public ObservableCollection<string> UserTypeOptions { get; } = new ObservableCollection<string> { "Manager", "Cashier", "Waitstaff" };
        ...
        public RelayCommand EditMenuItemCommand
        {
            get
            {
                return _editMenuItemCommand;
            }
        }
        public RelayCommand DeleteMenuItemCommand
        {
            get
            {
        ...
        public RelayCommand AddMenuItemCommand
        {
            get
            {
                return _addMenuItemCommand;
            }
        }
